...
public class ViewMember implements ActionListener
{
    ...
    {
        try{
            jfViewMember = new JFrame("Member Details");
    ...
    public JFrame getViewMember()
    {
        backPanel.add(bBack);
        pane = new JScrollPane(jtView, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        jfViewMember.add(pane, BorderLayout.CENTER);
        jfViewMember.add(backPanel, BorderLayout.SOUTH);
        jfViewMember.setSize(500,500);
        jfViewMember.setVisible(true);
        return jfViewMember;
    }
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            jfViewMember.dispose();
            AdminPage adminFrame;
            adminFrame = new AdminPage();
